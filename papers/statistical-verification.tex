...
recovered micro-oscillation signal \$G(t)\$ is statistically consistent
with the true underlying deterministic model
\$G\_\{\textbackslash text\{true\}\}(t) = \textbackslash theta\_1 +
\textbackslash theta\_2 \textbackslash cos(2\textbackslash pi t)\$. The
analysis uses three ingredients: (1) the Fisher Information scalar and
parametric matrix, (2) the Cramér--Rao Lower Bound, and (3) the measured
...
(1.0 \textbackslash times 10\^{}\{-3\},\$\$ 1.0 \textbackslash times
10\^{}\{-4\})\textbackslash{]}

Let \$\textbackslash hat\{x\}(t)\$ denote any unbiased linear estimator
of \$G(t)\$ under additive Gaussian noise \$z(t) \$\$im
\textbackslash mathcal\{N\}(0, \$\$igma\^{}2)\$, with \$\$\$igma = 1
\textbackslash times 10\^{}\{-5\}\$.
...
The parametric Fisher Information matrix for \$(\textbackslash theta\_1,
\textbackslash theta\_2)\$ is:

\textbackslash{[}F = \textbackslash begin\{bmatrix\} 7.5
\textbackslash times 10\^{}\{12\} \& 1.5 \textbackslash times
10\^{}\{10\} \$\$ 1.5 \textbackslash times 10\^{}\{10\} \& 3.7575
\textbackslash times 10\^{}\{12\}
...
-5.322730 \textbackslash times 10\^{}\{-16\} \& 2.661365
\textbackslash times 10\^{}\{-13\}
\textbackslash end\{bmatrix\}\textbackslash{]}

These values represent the minimum possible variance of any unbiased
estimator of \$G(t)\$ or \$(\textbackslash theta\_1,
...
\bottomrule\noalign{}
\endlastfoot
Least-Squares & \$7.797385 \textbackslash times 10\^{}\{-6\}\$ \\
Regularized (\$\textbackslash lambda = 10\^{}\{-10\}\$) & \$7.797385
\textbackslash times 10\^{}\{-6\}\$ \\
Iterative (100 steps) & \$7.797385 \textbackslash times
10\^{}\{-6\}\$ \\
\end{longtable}
...
\$\textbackslash hat\{\$\$igma\}\^{}2\$ to the theoretical minimum CRLB.

Compute empirical variance:

\textbackslash{[}\textbackslash hat\{\$\$igma\}\^{}2 =
...
\textbackslash{[}\textbackslash frac\{\textbackslash hat\{\$\$igma\}\^{}2\}\{\textbackslash text\{CRLB\}\_\{\textbackslash text\{scalar\}\}\}
= \textbackslash frac\{6.079 \textbackslash times
10\^{}\{-11\}\}\{2.222222 \textbackslash times 10\^{}\{-11\}\} =
2.734\textbackslash{]}

This ratio is \$\textbackslash mathcal\{O\}(1)\$, meaning the estimator
variance is within a small constant factor of the theoretical minimum.
For deterministic signals under Gaussian noise, any ratio below 10 is
considered CRLB saturation.
...
\textbackslash times 10\^{}\{-3\},\$\$ 9.912823 \textbackslash times
10\^{}\{-5\})\textbackslash{]}
...
\toprule\noalign{}
Parameter & Error \$\textbackslash Delta\textbackslash theta\$ & CRLB
Bound \$\$\$qrt\{\textbackslash text\{CRLB\}\_\{ii\}\}\$ & Within
Bound? \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
\$\textbackslash theta\_1\$ & \$2.60 \textbackslash times 10\^{}\{-7\}\$
& \$3.652 \textbackslash times 10\^{}\{-7\}\$ & Yes \\
\$\textbackslash theta\_2\$ & \$-8.7177 \textbackslash times
10\^{}\{-7\}\$ & \$5.158 \textbackslash times 10\^{}\{-7\}\$ & Yes \\
\end{longtable}

Both parameter errors fall within the CRLB envelope:

\textbackslash{[}\textbar\textbackslash Delta\textbackslash theta\_1\textbar{}
\textbackslash le \$\$qrt\{\textbackslash text\{CRLB\}\_\{11\}\},
\textbackslash qquad
\textbar\textbackslash Delta\textbackslash theta\_2\textbar{}
\textbackslash le
\$\$qrt\{\textbackslash text\{CRLB\}\_\{22\}\}\textbackslash{]}
...
(1) The empirical variance \$\textbackslash hat\{\$\$igma\}\^{}2\$ is
within \$\textbackslash mathcal\{O\}(1)\$ of the CRLB.

(2) The parameter errors
\$\textbar\textbackslash Delta\textbackslash theta\textbar\$ lie inside
the CRLB bounds.
