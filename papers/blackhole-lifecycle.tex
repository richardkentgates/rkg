...
\begin{abstract}
This paper extends the Unified Scalar Time-Gradient Field Theory from micro-scale decay anomalies to cosmic-scale cosmology. The scalar field $G(t)$ that explains nuclear decay-rate variations drives expansion at small amplitude, while black hole end-state relics produce the gravitational clustering attributed to cold dark matter. We numerically solve the Friedmann equation with scalar field dynamics, black hole mass evolution through evaporation to relic freeze-out, relic identity stability, linear perturbation growth, and observable predictions including rotation curves and gravitational lensing. All seven theory closure checks pass, demonstrating that a single field framework can simultaneously address anomalies across nuclear, gravitational, and cosmological domains.
\end{abstract}
