...
The scalar field $G(t)$ simultaneously addresses micro-scale decay anomalies, drives cosmic expansion at small amplitude, and produces the gradient-driven clustering component via black hole relic end-states. One field, multiple roles, no fine-tuning between scales.
